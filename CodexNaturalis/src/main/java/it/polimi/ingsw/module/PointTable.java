...
public class PointTable {
	...
	public int CountTarget(Player p,Board board, Target_Card[] targetCards) {
		int countOfTarget=0;
		if(p.getTarget().checkTarget(board)>0)
			countOfTarget++;
		for (Target_Card tc:targetCards){
	...
	public void updateCountTarget(Player p,Board board, Target_Card[] targetCards) {
		int countOfTarget=0;
		if(p.getTarget().checkTarget(board)>0)
			countOfTarget++;
		for (Target_Card tc:targetCards){
